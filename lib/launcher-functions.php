...
Options:
  ...
  --show-wp-errors        Show PHP notices and warnings information that were generated by the
                          WordPress core. (Default: only show notices and warnings from wp-config.php 
